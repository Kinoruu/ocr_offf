...
def train_my_model(optm, num, epochs):
    ...
    # — — — — — — — — — — — — — — — — #
    # Output
    model_ld.add(Dense(units=36, activation= "softmax"))
    ...
    plt.title('CNN_ld_' + str(num) + '.model training ' + optm + ' epochs ' + str(epochs) + 'test of LeNet-5 based neural network', fontsize=20)
    plt.xlabel('Predicted')
    plt.ylabel('Truth')
    #plt.show()
    plt.savefig('CNN_ld_' + str(num) + '.model training heatmap ' + optm + ' epochs ' + str(epochs) + 'test of LeNet-5 based neural network.png')
    #cv2.waitKey(1)

    plt.figure(figsize=(10, 5))
    plt.suptitle('CNN_ld_' + str(num) + '.model training ' + optm + ' epochs ' + str(epochs) + 'test of LeNet-5 based neural network', fontsize=20)
    ...
    #plt.show()
    plt.savefig('CNN_ld_' + str(num) + '.model training evaluation ' + optm + ' epochs ' + str(epochs) + 'test of LeNet-5 based neural network.png')
